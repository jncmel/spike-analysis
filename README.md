...
*Short video showing light evoked activity from multiple electrodes in an E16 chick retina with the polymer semiconductor in the subretinal configuration for two successive full field flashes of 500ms separated by a duration of 10s.*
<br/>
